...
try
	...
	caption = sprintf('Masked objects\nThe Red Objects');
	title(caption, 'FontSize', fontSize);
    ...
    maskedRGBImage = cat(3, maskedImageG, maskedImageR, maskedImageB);    
	% Show the masked off, original image.
	subplot(4, 3, 9);
	imshow(maskedRGBImage);
	fontSize = 13;
    ...
    maskedRGBImage = cat(3, maskedImageB, maskedImageG, maskedImageR);    
	% Show the masked off, original image.
	subplot(4, 3, 10);
	imshow(maskedRGBImage);
	fontSize = 13;
	caption = sprintf('Masked Original Image\nShowing Only the Blue Objects');
	title(caption, 'FontSize', fontSize);
